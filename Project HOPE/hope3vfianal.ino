...
const String data1 = "https://script.google.com/macros/s/AKfycbwON8UP7S_o7XWSFHFzD14Iw1-_ooyXZEUXM_1tDDyUCkrKLaT4YlCILMSUXSTVA8pncg/exec?cardno=";
const String data5 = "&&status=";
String data2;
...
//        Serial.println(mfrc522.GetStatusCodeName(status));  
  ...
  dataBlock[2] = buffer[2];
  dataBlock[3] = buffer[3];
  if(buffer[4] == 0x00){
    stat = 0;
    dataBlock[4] = 0x01;
  }
   ...
   data2 = data3 + data5 + String(stat); 
//    status = (MFRC522::StatusCode) mfrc522.MIFARE_Read(blockAddr, buffer, &size);
    
//  Serial.println(data3);
    Serial.println("3");
    Serial.println(buffer[4]);
    Serial.println(dataBlock[4]);
